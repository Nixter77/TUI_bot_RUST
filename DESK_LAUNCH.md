...
## Desk orchestrator (separate flag)

Paper-first one-process owner router: see **`DESK_ORCHESTRATOR.md`**.  
Flag `DESK_ORCHESTRATOR=1` (default off). Heat + double-book in that tip. Live multi still **BLOCK**.
