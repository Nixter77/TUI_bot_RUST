...
| **В ожидании входа** | **книга стратегии**, не топ 24h. S4 — ликвидный откат; **S2/S3 — majors BTC/ETH/SOL** (не лента %). Причина + **до входа:** окно сессии / % / VWAP / закрытие свечи. Вне часов — время до следующего старта UTC, не «ждёт свечу». |
