...
* **Сигнал на вход**: закрытие **дневной** свечи выше **40-дневного** максимума (Donchian 40) и close > **EMA100**. Зелёная свеча. ADX не режем — на held-out он ухудшал PF.
* **Таймфрейм**: `1d`, круглосуточно. `cargo --backtest` для S3 идёт по **1d**, не по 5m.
