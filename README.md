...
| **В ожидании входа** | **книга стратегии**, не топ 24h. Для S4 — ликвидный откат (объём, не догон %). Причина, почему ещё не купил, и **до входа:** сколько осталось (до окна сессии / % 24h / до VWAP / до закрытия свечи). Вне часов это **не** «ждёт свечу» — это время до следующего старта UTC. |
