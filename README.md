...
* **Вселенная**: ликвидный USDT-M (включая majors), не три монеты. Cap 80. **Не** TestNet-penny: цена ≥ 0.50 USDT, 24h ≤ +20%. Junk/1000x out. Слот live 1. BTC bear/panic — новых входов нет.
* **Сигнал на вход**: закрытие **дневной** свечи выше **40-дневного** максимума (Donchian 40) и close > **EMA100**. Зелёная свеча. Вход **только в первые 2 часа после 00:00 UTC**. Live last не ниже close и не дальше **+3%**. Стоп шире **10%** — skip.
